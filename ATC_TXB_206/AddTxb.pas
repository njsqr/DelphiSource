            ...
            with datam.txb do
              begin
                ...
                if radiogroup1.ItemIndex=0 then
                  ...
                  if radiogroup1.ItemIndex=1 then
                    sql.Add('select * from 066D where 产品型号='+''''+edit1.Text+'''')
                  else
                    if radiogroup1.ItemIndex=2 then
                      sql.Add('select * from 086 where 产品型号='+''''+edit1.Text+'''')
                    else
                      if radiogroup1.ItemIndex=3 then
                        sql.Add('select * from 106K where 产品型号='+''''+edit1.Text+'''')
                      else
                        if radiogroup1.ItemIndex=4 then
                          sql.Add('select * from 106 where 产品型号='+''''+edit1.Text+'''')
                        else
                          if radiogroup1.ItemIndex=5 then
                            sql.Add('select * from 166 where 产品型号='+''''+edit1.Text+'''')
                          else
                            sql.Add('select * from 206 where 产品型号='+''''+edit1.Text+'''');
                OPEN;
