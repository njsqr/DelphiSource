...
begin
  ...
  case flag of
    ...
    38      :       //OMEGA
      begin
        if datamodule1.ADOTable1.Locate('码值',copy(edit1.Text,1,11),[lopartialkey]) then
          begin
            label7.Visible:=true;
            label8.Visible:=false;
            edit2.Text:=datamodule1.ADOTable1.FieldValues['车厂'];
    ...
    30,40,50,60:    // 30,60 :依维柯 ;40,50：GPD
      ...
      62:    // GPD
      begin
        if datamodule1.ADOTable1.Locate('码值',copy(edit1.Text,1,10),[lopartialkey]) then
          begin
            label7.Visible:=true;
            label8.Visible:=false;
            edit2.Text:=datamodule1.ADOTable1.FieldValues['车厂'];
