...
begin
  ...
  prtstr := prtstr + PrtChnStr(45, 40, '黑体', 23, 2, 2, '件号：');
  prtstr := prtstr + PrtChnStr(200, 150, '黑体', 22, 2, 2, pchar('$'+Combobox1.Text));
  prtstr := prtstr + PrtChnStr(45, 195, '黑体', 23, 2, 2, '名称：'+Label9.Caption);
...
//  fileclose(filehandle);
  ...
  WriteRawStringToPrinter('Zebra-usb',prtstr);
end;
...
var n:integer;
begin
  n:=strtointdef(edit2.Text,MAXINT);
  if n=MAXINT then
    begin
      Edit2.text:='';
      Edit2.Setfocus;
