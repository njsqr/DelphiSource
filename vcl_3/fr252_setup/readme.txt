...
READ THIS FILE ACCURATELY BEFORE INSTALLING FR2.52!
...
get latest information. 
   ...
   FastReport 2.52 is "try before buy". See "Ordering" topic for details.
...
3. INSTALLING
   ...
   FR2.52 includes full source code. Trial version contains almost all sources
(only one compiled unit FR_Class.dcu / FR_class.obj ). 
! DON'T CHANGE ANYTHING IN FR.INC FILE OF TRIAL FR VERSION !

3.1. Run fr252.exe and follow to instructions of installation program
...
----------------------------------------------------------------------------
4. BACKWARD COMPATIBILITY
   .frf files from FR2.1...FR2.52 is compatible. You can use FR2.1 .frf
in FR2.52; but you can't use new .frf files in older FR versions and builds.
...
----------------------------------------------------------------------------
6. ORDERING
   FastReport 2.52 is "try before buy". You can try trial version of 
FastReport2.52, which prints only one page of report with nag label 
"FastReport - unregistered". Full version of FR shipped with full source code.
   Single copy of FR2.51 costs $99. Site license (unlimited number of copies)
...
to buy it even if you already registered FR 2.52).
